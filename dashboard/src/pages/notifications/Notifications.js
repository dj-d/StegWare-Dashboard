                    ...
                    <Widget disableWidgetMenu>
                        ...
                        <Grid container item xs={12}>
                            ...
                            <Grid item xs={4}>
                                ...
                                <Widget title="Layout Options" noWidgetShadow disableWidgetMenu noBodyPadding
                                        noHeaderPadding style={{ paddingRight: 15 }} headerClass={classes.widgetHeader}>
                            ...
                            <Grid item xs={4}>
                                ...
                                <Widget title="Notifications Types" disableWidgetMenu noBodyPadding noWidgetShadow
                                        noHeaderPadding style={{ paddingRight: 15 }} headerClass={classes.widgetHeader}>
                                    <Typography>
                            ...
                            <Grid item xs={4}>
                                ...
                                <Widget title="Usage" disableWidgetMenu noBodyPadding noWidgetShadow noHeaderPadding
